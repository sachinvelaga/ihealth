<?php /* Smarty version 2.6.0, created on 2014-01-10 03:13:48
         compiled from payment.tpl */ ?>
<div class="main">

  <form id="createprofile" name="createprofile" action="companyView.php" method="post" enctype="multipart/form-data">
  <div class="detail" style="margin-bottom:72px !important;">
  <h2>Create your administrator account</h2>
  <h6>This is the master log-in for your account. Once you've created your administrator account below, you will be able to add as many team members to your account as you'd like. Each user will have their own log-in information. </h6>
  
    <h3 style="color:red;"><?php echo $this->_tpl_vars['messageerror']; ?>
 </h3>

   <input type="hidden" name="email" value="<?php echo $this->_tpl_vars['email']; ?>
" />
    <input type="hidden" name="plan" value="<?php echo $this->_tpl_vars['plan']; ?>
" id="signplan" />
...
">
 <input type="hidden" name="planenddate" value="<?php echo $this->_tpl_vars['planenddate']; ?>
">
  
  <div class="company" style="margin-bottom:47px;">
 
  <div class="submit">
<!--<a href="$(this).closest('createprofile').submit();">-->
  <h4>
  <input type="submit" class="submit" value="Submit and Go To Next Step" id="btn_signup"  name="signupp"/>
...
<!--</a>-->
  ...
  function update()
  {
  //var vijay = document.getElementById("signplan").value;
  //alert(vijay);
 document.createprofilee.submit();
