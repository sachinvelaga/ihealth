<?php /* Smarty version 2.6.0, created on 2013-10-22 03:14:27
         compiled from viewUsers.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'viewUsers.tpl', 80, false),)), $this); ?>
 ...
 ?>
                            ...
                            <tbody>
								...
								<tr class="header-title-bg">
									...
									<th width="15%" style="text-align:center;" class="line1">User Status</th>
								</tr>
...
?>
                             ...
                             <?php echo $this->_tpl_vars['currdata']['departmentname']; ?>
                                   	...
                                   	<td align="center" style="font-size:16px !important;" id="status_<?php echo $this->_tpl_vars['currdata']['locationId']; ?>
">
<?php if ($this->_tpl_vars['currdata']['responseStatus'] == '1'): ?><h3 style="color:green; padding:0 0 3px 0; font-size:16px;">Active</h3><?php elseif ($this->_tpl_vars['currdata']['responseStatus'] == '0'): ?><h3 style="color: #5d5c5d!important;padding:0 0 3px 0; font-size:16px;">Inactive</h3><?php endif; ?> 
                                    </td>
