<?php /* Smarty version 2.6.0, created on 2013-10-30 06:16:06
         compiled from passwordLink.tpl */ ?>
<div align="center"  style="margin-left: 218px;  margin-top:0;  width: 550px;"> <br/>
  ...
  <div id="BtnSpace1">
    ...
    <form name="frmAdd" id="frmAdd" method="post">
      <div class="header_home header_home001" style="text-align:left;">Verification link</div>
      <div id="Btn_MiddalSpace1" style="margin-top:10px; text-align:left;">
        <div id="Btn_MiddalSpace_innar1">
          ...
          <div class="resend_ta1" style="float:right !important;padding:0 0 0 313px !important; width:406px !important; min-height:220px !important;">
          <h3>Send Verification Link</h3>
            <input name="email" id="email" type="text" class="validate[required] input_login" value="Enter your Email"  onFocus="this.value=''" />
             <input name="password" id="password" type="password" class="validate[required] input_login" value="Password"  onFocus="this.value=''" />
