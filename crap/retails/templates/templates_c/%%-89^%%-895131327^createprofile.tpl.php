<?php /* Smarty version 2.6.0, created on 2014-04-22 10:41:16
 ...
 <div class="content column-full container">
     ...
     <form class="form-horizontal" role="form" name="createprofile" method="POST" action="" style="margin: 20px 0 0 0;">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="inputEmail3" name="companyname" value="" required>
          </div>
      ...
      <div class="page-header">
        ...
        <div class="form-group" style="margin-top:20px;">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="inputEmail3" name="name" value"" required>
          </div>
        </div>
        <div class="form-group">
