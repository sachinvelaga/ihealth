<?php /* Smarty version 2.6.0, created on 2014-01-06 07:32:47
         compiled from scenarioActive.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'scenarioActive.tpl', 560, false),array('modifier', 'capitalize', 'scenarioActive.tpl', 566, false),array('modifier', 'urldecode', 'scenarioActive.tpl', 621, false),)), $this); ?>
<?php echo ' 
			...
			function(data){
				...
				// $(\'#frmAdd\').submit();
					...
					var msg = $(\'#launch_msg\').val();
						location.href = "activationAdd.php?page="+page+"&sid=" +s_id+"&msg=" +msg+"&aid="+a_id;
					}
						...
						location.href = "cancel.php?page="+page+"&sid="+s_id+"&aid="+a_id+"&sname="+sname+"&sact="+sact;
					}else if(action=="unactivate") {
					var msg = $(\'#close_msg\').val();
						location.href = "update.php?page="+page+"&sid=" +s_id+"&msg=" +msg+"&aid="+a_id;
					}					
					else if(action=="deactivate"){
					
					var msg = $(\'#deact_msg\').val();
						location.href = "deactivateAdd.php?page="+page+"&sid=" +s_id+"&msg=" +msg+"&aid="+a_id;
					}
				}
				else {
...
">
          ...
          <thead>
          <th width="5%"><span></span><span class="sort-data"></span></th>
            <th width="15%"><span>Scenario Name</span><span class="sort-data"><i class="icon-bg asc sort_trig" onclick="tsort($(this),'f1-a')"></i><i class="icon-bg desc sort_trig" onclick="tsort($(this),'f1-d')"></i></span></th>
            <th width="15%"><span>Locations</span><span class="sort-data"><i class="icon-bg asc sort_trig" onclick="tsort($(this),'f2-a')"></i><i class="icon-bg desc sort_trig" onclick="tsort($(this),'f2-d')"></i></span></th>
            <th width="15%"><span>Reports</span><span class="sort-data"><i class="icon-bg asc sort_trig" onclick="tsort($(this),'f3-a')"></i><i class="icon-bg desc sort_trig" onclick="tsort($(this),'f3-d')"></i></span></th>
            <th width="15%" class="al-c"><span>Notifications</span><span class="sort-data"><i class="icon-bg asc sort_trig" onclick="tsort($(this),'f4-a')"></i><i class="icon-bg desc sort_trig" onclick="tsort($(this),'f4-d')"></i></span></th>
            <th width="15%" class="al-c"><span>Status</span><span class="sort-data"><i class="icon-bg asc sort_trig" onclick="tsort($(this),'f5-a')"></i><i class="icon-bg desc sort_trig" onclick="tsort($(this),'f5-d')"></i></span></th>
            <th width="15%" class="al-c"> Actions</th>
              </thead>
          <tbody class="table1">
  ...
  <form class="form-horizontal">   
          ...
          <div class="control-group over_size edit_scenario">
            ...
            <div class="addnam addhigh">
             <p class="name_scena sub_clas edit_scenario_name02" style="width:60%; line-height:30px !important; display: table !important;" id = "launchdept"></p>
             </div>
            </div>
          </div>
          <div class="control-group over_size edit_scenario">
