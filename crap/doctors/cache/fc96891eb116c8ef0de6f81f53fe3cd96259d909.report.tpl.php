<?php /*%%SmartyHeaderCode:1133765786543ce109a2a905-26329705%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc96891eb116c8ef0de6f81f53fe3cd96259d909' => 
    array (
  ...
  'nocache_hash' => '1133765786543ce109a2a905-26329705',
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_543ce153a743d1_83013426',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543ce153a743d1_83013426')) {function content_543ce153a743d1_83013426($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
		<meta charset="UTF-8" />
...
function commentupdate(y){
	var insertdate = $('#insertdate_'+y).val();
	...
	if(comment.length==0){
	 ...
	 $.ajax({
                  url:"commentupdt.php",
                  type:"POST",
				  data:{mainid:y,comment:comment,commenton:commenton,cstat:cstat,indate:insertdate},
                  success:function(resp){
	...
	<div class="schools-div">
		<div class="school-name">
            ...
            <select id="school-div" name="country" onchange="classlist()" class="form-control" required>
				...
				<option value=1>JJVM</option><option value=2>Acharya</option>
            </select>
         		 </div>
       		 </div>
		</div>
        <div class="class-name">
		   ...
		   <input type="hidden" id="selctedschool"/>
		  	<select style="display:none;" id="standard_1" onchange="sectionslist()" name="standard" class="form-control" required>
...
<!-----Report Div End--->
       ...
       <div style="width:90%; text-align: center; color: #0088cc; margin-top: 20px;">Suresh Reddy</div> <div style="width:90%; margin-top:10px;">
