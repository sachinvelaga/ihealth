<?php /*%%SmartyHeaderCode:722369130543ce1047c09e5-69309138%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a8525bdc41000e9365c04ee6fb531edd6597db5' => 
    array (
  ...
  'nocache_hash' => '722369130543ce1047c09e5-69309138',
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_543ce149395a51_61664726',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543ce149395a51_61664726')) {function content_543ce149395a51_61664726($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
		<meta charset="UTF-8" />
    ...
    <div style="width:100%; overflow: hidden;">
    	<div style="width:85%; height:700px; float:left;border-right:4px solid #a5c451; position:absolute; overflow:hidden;">
            ...
            <div style="width:100%;min-height:500px; border-top:4px solid #a5c451; overflow: hidden;">
            	<div style="width:100%; margin: 20px;"> <div class="person-details1">   
	<p id="less_message_content694">
	<div class="person_details">
		<div class = "person_details-left"> Name	:	</div><div class = "person_details-right">Suresh Reddy</div>		
	</div>
	</p>
	<p id="less_message_content694">
	<div class="person_details">
		<div class = "person_details-left"> Hospital Name	:	</div><div class = "person_details-right">Applo</div>		
	</div>									
	</p>
	<p id="less_message_content694">
		<div class="person_details">
		<div class = "person_details-left">Age :	</div><div class = "person_details-right">19 years	</div>		
	</div>								
	</p> 
	<p id="less_message_content694">
		<div class="person_details">
		<div class = "person_details-left"> Gender : 		</div><div class = "person_details-right">Marathalli</div>		
	</div>
	</p>							
