<?php /*%%SmartyHeaderCode:1119251081543ce20bb9f509-87264686%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c046a49213e9c7bd6f69534aa2be41efcaa7070b' => 
    array (
      0 => 'templates/lib/report.tpl',
      1 => 1409252914,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1119251081543ce20bb9f509-87264686',
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_543fc5a4658398_47041645',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543fc5a4658398_47041645')) {function content_543fc5a4658398_47041645($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
		<meta charset="UTF-8" />
...
function heartbeat(x){
	var hb = $('#hb_'+x).val();
		var htm ='<div style="width:100%;margin: 0 !important;padding: 0 !important;"><div style="width:100%;"><p align="center"><audio controls="controls"><source src="../music/'+hb+'" type="audio/mpeg"></audio></p></div>';
		$('.hidecont').hide();
		$('#extra').show();
	$('#extra').html(htm);
	...
	function ecgview(x){
	var ecg = $('#ecg_'+x).val();
		var htm ='<div style="width:100%;margin: 0 !important;padding: 0 !important;"><div style="width:100%;"><p align="center"><img width="420" height="310" alt="ecg" src="../ecg/'+ecg+'"></div>';
		$('.hidecont').hide();
		$('#extra').show();
	$('#extra').html(htm);
	$('#myModal').reveal({ animation : 'none'});
...
<div style="width:100%; overflow: hidden;">
    	<div style="width:85%; height:700px; float:left;border-right:4px solid #a5c451; position:absolute; overflow:hidden;">
            ...
            <div style="width:100%;min-height:500px; border-top:4px solid #a5c451; overflow: hidden;">
            	<div style="width:100%; margin: 20px;"><div id="health-tab" style="height:auto;padding-bottom:10px;">
<div class="container_table_details" >
	<div class="schools-div" style="width: 60% !important;">
		<div class="school-name">
		     <div class="form-group" style="height:35px !important;weight:103% !important;">
          		<div class="col-sm-4">
           <input type="hidden" id="selctedschool"/>
		  	<input type="hidden" id="school-div" value="1"><select id="standard_1" onchange="sectionslist()" name="standard" class="form-control" required>
			
				<option value="0">Select Class</option><option value=Pre-KG>Pre-KG</option><option value=LKG>LKG</option><option value=UKG>UKG</option><option value=1>1</option><option value=2>2</option><option value=3>3</option><option value=4>4</option><option value=5>5</option></select>
		         		 </div>
       		 </div>
		</div>
	</div>
...
<!-----Report Div End--->
       ...
       <div style="width:90%; text-align: center; color: #0088cc; margin-top: 20px;">Harinath</div> <div style="width:90%; margin-top:10px;">
			<img src="../profilepics/gent_doc.jpg">
			
			</div>
          <div style="width:95%; height:auto;" class="menu_simple">
<ul>
<li><a href="index.php" class="serviceactive" id="acctab">My Account</a></li>
<li><a href="report.php" class="serviceactive" id="stdtab">Student Report</a></li>
...
<div id="connections-menu">
            <ul id="connect-ul"> 
			 <li><a href="index.php" data-original-title="">My Profile</a></li>
			  <li id="hel" class="active"><a href="javascript:" data-original-title="">Student Report</a></li>
          	  </ul>   
						<!-- customize utter -->
...
<div style="width:100%; text-align:center;border-bottom:4px solid #A5C451; " >
    ...
    <table class="hidecont" style="width:100%">
		<tr>
			<td style="width:40%; text-align:center;">Comment</td>
			<td style="width:40%; text-align:center;"><p name="comments" class="pftcomment" style="margin-bottom:2px;width:90%; height:auto; "></p></td>
            </tr></table>
   <div class="hidecont" id="content" style="margin-top: 50px;">
  
    </div>
     <div class="hidecont" id="extra" style="margin-top: 50px;">
