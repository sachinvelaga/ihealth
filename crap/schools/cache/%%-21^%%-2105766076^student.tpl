a:4:{s:8:"template";a:2:{s:11:"student.tpl";b:1;s:10:"header.tpl";b:1;}s:9:"timestamp";i:1401114274;s:7:"expires";i:1401114274;s:13:"cache_serials";a:0:{}}
<!DOCTYPE html>
<html lang="en">
    <head>
		<meta charset="UTF-8" />
...
<div id="connections-menu">
            <ul id="connect-ul" style="float:right;"> 
              <li><div style="width:35px;height:35px;margin-top:16px;margin-right:2px;"><a href="index.php"><img src="../profilepics/gent_doc.jpg"></a></div></li>
			  <li style="margin-top:15px;"><a href="index.php" data-original-title="">Suresh Reddy</a></li>
