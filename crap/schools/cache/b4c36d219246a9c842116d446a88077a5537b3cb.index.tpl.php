...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_543fc58aa23d61_19969999',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543fc58aa23d61_19969999')) {function content_543fc58aa23d61_19969999($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
		<meta charset="UTF-8" />
...
<div style="width:100%; overflow: hidden;">
	...
	<div class="person_details">
		<div class = "person_details-left"> Name	:	</div><div class = "person_details-right">Harinath</div>		
	</div>
	</p>
	<p id="less_message_content694">
	<div class="person_details">
		<div class = "person_details-left"> School Name	:	</div><div class = "person_details-right">JJVM</div>		
	</div>									
	</p>
	<p id="less_message_content694">
		<div class="person_details">
		<div class = "person_details-left">Age :	</div><div class = "person_details-right">30 years	</div>		
	</div>								
	</p> 
	<p id="less_message_content694">
		<div class="person_details">
		<div class = "person_details-left"> Gender : 		</div><div class = "person_details-right">Puttur</div>		
	</div>
	</p>							
