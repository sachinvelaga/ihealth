...
$data[$sch] .='<input type="hidden" id="school-div" value="'.$sch.'"><select id="standard_'.$sch.'" onchange="sectionslist()" name="standard" class="form-control" required>
