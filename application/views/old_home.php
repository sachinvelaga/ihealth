...
<div id="hadr" style="width:98%; height:auto; text-align:center;  border-width:1px; top:2%; left:1%; position:absolute; background-color:rgb(49, 212, 231); opacity: 0.6;">
            ...
            <div style="width:100%;">
             <ul id="menu" style="float:right; width:50%; padding:0px !important; list-style:none outside none;">
                 {if $ses_id}
                <li>{if $logged == 'nurse'}<a href="nurses/index.php">My Account</a>{elseif $logged == 'parent'}<a href="parents/index.php">My Account</a>{elseif $logged == 'doctors'}<a href="doctors/index.php">My Account</a>{elseif $logged == 'schools'}<a href="schools/index.php">My Account</a>{/if}
                
                
                </li>
                {else}
                 <li style="text-align:center;"><a onclick="fancypop()" href='javascript:'>Login</a>
